...
| Metric | Transformer | LightGBM |
|--------|-------------|----------|
| Top-4 recall | 0.9627 | 0.9581 |
| Top-1 accuracy | 0.5817 | 0.5757 |
| Log-loss | 1.0475 | 1.1137 |
| Brier score | 0.5337 | 0.5573 |
| ECE | 0.0267 | 0.0461 |

**Per-class Top-4 recall:**

| Class | Transformer | LightGBM |
|-------|-------------|----------|
| Ball | 0.9795 | 0.9738 |
| Strike | 0.9577 | 0.9521 |
| Single | 0.9820 | 0.9886 |
| Double | 0.3752 | 0.4856 |
| Triple | 0.0000 | 0.0091 |
| Home Run | 0.5652 | 0.2463 |
| Strikeout | 0.9926 | 1.0000 |
| Walk | 0.9853 | 0.9898 |
| Hit by Pitch | 0.9757 | 0.9489 |
| Field Out | 0.9979 | 0.9970 |

### Hit Location

| Metric | Transformer | LightGBM |
|--------|-------------|----------|
| Top-4 recall | 0.6912 | 0.6417 |
| Top-1 accuracy | 0.2035 | 0.1845 |
| Log-loss | 2.0492 | 2.1330 |
| Brier score | 0.8559 | 0.8687 |
| ECE | 0.0386 | 0.0167 |
...
| Class | Transformer | LightGBM |
|-------|-------------|----------|
| Pitcher | 0.5115 | 0.5976 |
| Catcher | 0.2221 | 0.1663 |
| First Base | 0.6612 | 0.6199 |
| Second Base | 0.6472 | 0.6386 |
| Third Base | 0.6585 | 0.6234 |
| Shortstop | 0.6276 | 0.6045 |
| Left Field | 0.7462 | 0.6910 |
| Center Field | 0.7515 | 0.6372 |
| Right Field | 0.7258 | 0.6646 |
| None | 0.7673 | 0.7284 |

### Physics — Transformer only (contact pitches)
